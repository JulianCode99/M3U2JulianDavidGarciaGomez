...
var tbController = (function() {
    ...
    return {
        ...
        addNewList() {
            var newList = {id:uuidv4(), title: "Nueva Lista", tasks: []};
            ...
            if(obj.length !== 0) {
                for(let member of obj) {
                    html += `<li class="list-group-item member-in-list" data-id=${member.id}>
                            ...
                            <div>
                                <button type="button" class="btn btn-primary member-edit-btn seen" id="edit-btn">Editar</button>
                                <button type="button" class="btn btn-danger member-delete-btn seen" id="delete-btn">Eliminar</button>
                                <button type="button" class="btn btn-success member-save-btn" id="save-btn">Guardar</button>
                                <button type="button" class="btn btn-secondary member-cancel-btn" id="cancel-btn">Cancelar</button>
                            </div>
                        </li>`;
        ...
        loadBoardToUI(obj) {
            ...
            for(let list of obj) {
                ...
                <div class="panel_footer">
                    <button class="btn-add_a_card" id="btn-add-card">Añadir Tarea</button>
                            </div>
                        </div>
                    </div>
                </li>`;
                                ...
                                <div class="list-content">
                                    <div class="panel">
                                        <div class="panel_header">
                                            ...
                                            <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" id="delete_list_btn">Eliminar Lista</a>
                                            </div>
                                          </div>
                                        </div>
...
var controller = (function(tbCtrl,UICtrl) {
    ...
    var ctrlDeleteMember = function(event) {
        ...
        if(memberID && event.target.id === "delete-btn" && confirm("Estas seguro de eliminar el Usuario?")) {
    ...
    var ctrlDeleteList = function(event) {
        ...
        if(ListID && event.target.id === "delete_list_btn" && confirm("Estas seguro de eliminar esta Lista?")) {
            // 1. Delete the member from data structure
    ...
    var ctrlDeleteCard = function(event) {
        ...
        if(event.target.id === "delete_card-btn" && confirm("Estas Seguro De Eliminar Esta Tarea?")) {
